...
public class DiagramEditorInputFactory implements IElementFactory {
     ...
     */
    public static final String ID_FACTORY = "ru.agentlab.jfxed.editors.DiagramEditorInputFactory"; //$NON-NLS-1$
...
/*        String viewID = memento.getString(TAG_VIEW_ID);
        ...
        return null;//new NullDiagramEditorInput(fileName, viewName);
    }
