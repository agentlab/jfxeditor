...
public class BusinessProcessModelandNotation implements IDiagram {
	static String SOURCE = "http://www.agentlab.ru/jfxed/onto/BusinessProcessModelandNotation"
