package ru.agentlab.jfxed.diagramms.InfDia
...
public class ClazzDiagram implements IDiagram {
	static String SOURCE = "http://www.agentlab.ru/jfxed/onto/influencediagram"
	...
	override createJfx(OntModel jenaModel, XDiagram jfxDiagram) {
		...
		select ?uri 
		where { 
			?uri rdf:type <«SOURCE»#generalVariable> 
		} 
		'''
