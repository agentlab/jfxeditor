package ru.agentlab.jfxed.diagramms.applicationCooperation
...
import ru.agentlab.jfxed.figures.actor.ActorFigure

public class ApplicationCooperation implements IDiagram {
