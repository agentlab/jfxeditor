package ru.agentlab.jfxed.diagramms.bfv
...
import ru.agentlab.jfxed.figures.service.ServiceFigure

public class BFV implements IDiagram {
	...
	override createJfx(OntModel jenaModel, XDiagram jfxDiagram) {
		...
		select ?uri 
		where { 
			?uri rdf:type <«SOURCE»#BusinessFunction> 
		} 
		'''
