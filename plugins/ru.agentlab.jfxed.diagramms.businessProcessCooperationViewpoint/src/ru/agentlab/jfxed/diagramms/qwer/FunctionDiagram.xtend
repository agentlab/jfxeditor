package ru.agentlab.jfxed.diagramms.qwer
...
import ru.agentlab.jfxed.figures.function.ClassFigure

public class FunctionDiagram implements IDiagram {
	static String SOURCE = "http://www.agentlab.ru/jfxed/onto/gold"
