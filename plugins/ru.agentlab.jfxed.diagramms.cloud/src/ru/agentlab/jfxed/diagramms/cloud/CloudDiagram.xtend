package ru.agentlab.jfxed.diagramms.cloud
...
public class CloudDiagram implements IDiagram {
	static String SOURCE = "http://www.agentlab.ru/jfxed/onto/cloud"
	...
	override createJfx(OntModel jenaModel, XDiagram jfxDiagram) {
		...
		select ?uri 
		where { 
			?uri rdf:type <«SOURCE»#ConceptClass> 
		} 
		'''
