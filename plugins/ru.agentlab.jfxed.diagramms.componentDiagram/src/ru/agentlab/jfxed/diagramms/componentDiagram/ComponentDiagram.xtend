package ru.agentlab.jfxed.diagramms.componentDiagram
...
import ru.agentlab.jfxed.figures.state_3.State3Figure

public class ComponentDiagram implements IDiagram {
	...
	override createJfx(OntModel jenaModel, XDiagram jfxDiagram) {
		...
		select ?uri 
		where { 
			?uri rdf:type <«SOURCE»#OrderSystem> 
		} 
		'''
