...
public class Diagramm {
	...
	public static void main (String[] args){
		...
		ObjectProperty propAttrTo = m.createObjectProperty(NS + "Attribution To");//объекты - свойства
		 ...
		 * */
		//
		OntClass relationClass = m.createClass(NS + "Relation");//родительский суперкласс
		//для того чтобы отличать фигурки от связей
		
		OntClass relationshipClass = m.createClass(NS + "Relationship");//связь Relatinship
		OntClass attrRelationshipClass = m.createClass(NS + "Attribute Relationship");//связь Attribute Relationship

		
		//сюда повсему мы говорим что наши стрелочки это association
		relationshipClass.addSuperClass(relationClass);//родительская связь
		attrRelationshipClass.addSuperClass(relationClass);//родительская связь
		/*
		 * end
		 * */
		 ...
		 *  CONCEPT
		 * */
		OntClass conceptClass = m.createClass(NS + "Concept");//родительский суперкласс
		//для того чтобы отличать атрибуты
		...
		attributeConceptClass.addSuperClass(conceptClass);//родительская связь
		entityConceptClass.addSuperClass(conceptClass);//родительская связь
		/*
		 * end
		 * */
		...
		m.write(System.out, "N3");//вывод в консоль
		}
