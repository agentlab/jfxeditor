package ru.agentlab.jfxed.diagramms.serviceRealization
...
import ru.agentlab.jfxed.figures.network.NetworkFigure

public class ServiceRealization implements IDiagram {
	...
	override createJfx(OntModel jenaModel, XDiagram jfxDiagram) {
		...
		select ?uri 
		where { 
			?uri rdf:type <«SOURCE»#BusinessService> 
		} 
		'''
